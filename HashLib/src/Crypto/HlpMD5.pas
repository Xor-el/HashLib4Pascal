...
begin
  ...
  LRegA := TBitOperations.RotateLeft32(LRegA, 4) + LRegB;
  LRegD := LData[8] + $8771F681 + LRegD + (LRegA xor LRegB xor LRegC);
  LRegD := TBitOperations.RotateLeft32(LRegD, 11) + LRegA;
  LRegC := LData[11] + $6D9D6122 + LRegC + (LRegD xor LRegA xor LRegB);
  LRegC := TBitOperations.RotateLeft32(LRegC, 16) + LRegD;
  LRegB := LData[14] + $FDE5380C + LRegB + (LRegC xor LRegD xor LRegA);
  LRegB := TBitOperations.RotateLeft32(LRegB, 23) + LRegC;
  ...
  LRegA := TBitOperations.RotateLeft32(LRegA, 6) + LRegB;
  LRegD := LData[7] + $432AFF97 + LRegD + (LRegB xor (LRegA or not LRegC));
  LRegD := TBitOperations.RotateLeft32(LRegD, 10) + LRegA;
  LRegC := LData[14] + $AB9423A7 + LRegC + (LRegA xor (LRegD or not LRegB));
  LRegC := TBitOperations.RotateLeft32(LRegC, 15) + LRegD;
  LRegB := LData[5] + $FC93A039 + LRegB + (LRegD xor (LRegC or not LRegA));
  LRegB := TBitOperations.RotateLeft32(LRegB, 21) + LRegC;
