...
begin
  ...
  LRegB := TBitOperations.RotateLeft32(LRegB, 7);
  ...
  LRegB := TBitOperations.RotateLeft32(LRegB, 6);
  ...
  LRegC := TBitOperations.RotateLeft32(LRegC, 5);
  ...
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 12);
  ...
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 6);
  ...
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 14);
  ...
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 15);
  ...
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 9);
