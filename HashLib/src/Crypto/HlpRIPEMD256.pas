...
begin
  ...
  LRegD := TBitOperations.RotateLeft32(LRegD, 12);
  ...
  LRegA := TBitOperations.RotateLeft32(LRegA, 7);
  ...
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 13);
  ...
  LRegC := TBitOperations.RotateLeft32(LRegC, 6);
  ...
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 15);
  ...
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 5);
  ...
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 5);
  ...
  LRegA := TBitOperations.RotateLeft32(LRegA, 13);
  ...
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 7);
  LRegB := LRegB + (LData[13] + C5 + ((LRegCc and LRegDd) or (not LRegCc and LRegA)));
  LRegB := TBitOperations.RotateLeft32(LRegB, 5);
  ...
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 14);
  ...
  LRegD := TBitOperations.RotateLeft32(LRegD, 15);
  ...
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 8);
  LRegAa := LRegAa + (LData[13] + C6 + ((LRegBb and LRegD) or (LRegCc and not LRegD)));
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 9);
  ...
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 12);

  LRegA := LRegA + (LData[8] + (LRegB xor LRegC xor LRegDd));
  LRegA := TBitOperations.RotateLeft32(LRegA, 15);
  LRegDd := LRegDd + (LData[6] + (LRegA xor LRegB xor LRegC));
  LRegDd := TBitOperations.RotateLeft32(LRegDd, 5);
  ...
  LRegA := TBitOperations.RotateLeft32(LRegA, 14);
  ...
  LRegC := TBitOperations.RotateLeft32(LRegC, 12);
