...
begin
  ...
  LRegB := TBitOperations.RotateLeft32(LRegB, 7) + LRegA;
  LRegD := TBitOperations.RotateLeft32(LRegD, 10);
  LRegA := LRegA + (LData[0] + C2 + ((LRegB and LRegC) or (not LRegB and LRegD)));
  LRegA := TBitOperations.RotateLeft32(LRegA, 12) + LRegE;
  LRegC := TBitOperations.RotateLeft32(LRegC, 10);
  ...
  LRegA := TBitOperations.RotateLeft32(LRegA, 13) + LRegE;
  LRegC := TBitOperations.RotateLeft32(LRegC, 10);
  ...
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 12) + LRegEe;
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 10);
  ...
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 7) + LRegEe;
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 10);
  ...
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 13) + LRegEe;
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 10);
  ...
  LRegA := TBitOperations.RotateLeft32(LRegA, 7) + LRegE;
  LRegC := TBitOperations.RotateLeft32(LRegC, 10);
  ...
  LRegC := TBitOperations.RotateLeft32(LRegC, 6) + LRegB;
  LRegE := TBitOperations.RotateLeft32(LRegE, 10);
  ...
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 11) + LRegEe;
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 10);
  ...
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 14) + LRegAa;
  LRegDd := TBitOperations.RotateLeft32(LRegDd, 10);
  ...
  LRegB := TBitOperations.RotateLeft32(LRegB, 12) + LRegA;
  LRegD := TBitOperations.RotateLeft32(LRegD, 10);
  ...
  LRegD := TBitOperations.RotateLeft32(LRegD, 14) + LRegC;
  LRegA := TBitOperations.RotateLeft32(LRegA, 10);
  ...
  LRegC := TBitOperations.RotateLeft32(LRegC, 5) + LRegB;
  LRegE := TBitOperations.RotateLeft32(LRegE, 10);
  ...
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 14) + LRegEe;
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 10);
  ...
  LRegDd := TBitOperations.RotateLeft32(LRegDd, 15) + LRegCc;
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 10);
  LRegCc := LRegCc + (LData[14] + C7 + ((LRegDd and LRegEe) or (not LRegDd and LRegAa)));
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 8) + LRegBb;
  LRegEe := TBitOperations.RotateLeft32(LRegEe, 10);
  ...
  LRegA := TBitOperations.RotateLeft32(LRegA, 15) + LRegE;
  LRegC := TBitOperations.RotateLeft32(LRegC, 10);
  LRegE := LRegE + (LData[5] + C8 + (LRegA xor (LRegB or not LRegC)));
  LRegE := TBitOperations.RotateLeft32(LRegE, 5) + LRegD;
  LRegB := TBitOperations.RotateLeft32(LRegB, 10);
  ...
  LRegE := TBitOperations.RotateLeft32(LRegE, 11) + LRegD;
  LRegB := TBitOperations.RotateLeft32(LRegB, 10);
  ...
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 5) + LRegEe;
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 10);
  ...
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 13) + LRegBb;
  LRegEe := TBitOperations.RotateLeft32(LRegEe, 10);
  ...
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 11) + LRegAa;
  LRegDd := TBitOperations.RotateLeft32(LRegDd, 10);
