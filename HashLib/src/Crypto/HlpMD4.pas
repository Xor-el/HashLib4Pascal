...
begin
  ...
  LRegA := TBitOperations.RotateLeft32(LRegA, 3);
  ...
  LRegC := TBitOperations.RotateLeft32(LRegC, 11);
  LRegB := LRegB + (LData[3] + ((LRegC and LRegD) or ((not LRegC) and LRegA)));
  LRegB := TBitOperations.RotateLeft32(LRegB, 19);
  ...
  LRegD := TBitOperations.RotateLeft32(LRegD, 5);
