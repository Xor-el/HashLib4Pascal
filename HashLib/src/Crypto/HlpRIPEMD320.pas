...
begin
  ...
  LRegA := TBitOperations.RotateLeft32(LRegA, 11) + LRegE;
  LRegC := TBitOperations.RotateLeft32(LRegC, 10);
  LRegE := LRegE + (LData[1] + (LRegA xor LRegB xor LRegC));
  LRegE := TBitOperations.RotateLeft32(LRegE, 14) + LRegD;
  LRegB := TBitOperations.RotateLeft32(LRegB, 10);
  LRegD := LRegD + (LData[2] + (LRegE xor LRegA xor LRegB));
  LRegD := TBitOperations.RotateLeft32(LRegD, 15) + LRegC;
  LRegA := TBitOperations.RotateLeft32(LRegA, 10);
  LRegC := LRegC + (LData[3] + (LRegD xor LRegE xor LRegA));
  LRegC := TBitOperations.RotateLeft32(LRegC, 12) + LRegB;
  LRegE := TBitOperations.RotateLeft32(LRegE, 10);
  LRegB := LRegB + (LData[4] + (LRegC xor LRegD xor LRegE));
  LRegB := TBitOperations.RotateLeft32(LRegB, 5) + LRegA;
  LRegD := TBitOperations.RotateLeft32(LRegD, 10);
  LRegA := LRegA + (LData[5] + (LRegB xor LRegC xor LRegD));
  LRegA := TBitOperations.RotateLeft32(LRegA, 8) + LRegE;
  LRegC := TBitOperations.RotateLeft32(LRegC, 10);
  LRegE := LRegE + (LData[6] + (LRegA xor LRegB xor LRegC));
  LRegE := TBitOperations.RotateLeft32(LRegE, 7) + LRegD;
  LRegB := TBitOperations.RotateLeft32(LRegB, 10);
  LRegD := LRegD + (LData[7] + (LRegE xor LRegA xor LRegB));
  LRegD := TBitOperations.RotateLeft32(LRegD, 9) + LRegC;
  LRegA := TBitOperations.RotateLeft32(LRegA, 10);
  LRegC := LRegC + (LData[8] + (LRegD xor LRegE xor LRegA));
  LRegC := TBitOperations.RotateLeft32(LRegC, 11) + LRegB;
  LRegE := TBitOperations.RotateLeft32(LRegE, 10);
  LRegB := LRegB + (LData[9] + (LRegC xor LRegD xor LRegE));
  LRegB := TBitOperations.RotateLeft32(LRegB, 13) + LRegA;
  LRegD := TBitOperations.RotateLeft32(LRegD, 10);
  LRegA := LRegA + (LData[10] + (LRegB xor LRegC xor LRegD));
  LRegA := TBitOperations.RotateLeft32(LRegA, 14) + LRegE;
  LRegC := TBitOperations.RotateLeft32(LRegC, 10);
  LRegE := LRegE + (LData[11] + (LRegA xor LRegB xor LRegC));
  LRegE := TBitOperations.RotateLeft32(LRegE, 15) + LRegD;
  LRegB := TBitOperations.RotateLeft32(LRegB, 10);
  LRegD := LRegD + (LData[12] + (LRegE xor LRegA xor LRegB));
  LRegD := TBitOperations.RotateLeft32(LRegD, 6) + LRegC;
  LRegA := TBitOperations.RotateLeft32(LRegA, 10);
  LRegC := LRegC + (LData[13] + (LRegD xor LRegE xor LRegA));
  LRegC := TBitOperations.RotateLeft32(LRegC, 7) + LRegB;
  LRegE := TBitOperations.RotateLeft32(LRegE, 10);
  LRegB := LRegB + (LData[14] + (LRegC xor LRegD xor LRegE));
  LRegB := TBitOperations.RotateLeft32(LRegB, 9) + LRegA;
  LRegD := TBitOperations.RotateLeft32(LRegD, 10);
  ...
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 8) + LRegEe;
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 10);
  LRegEe := LRegEe + (LData[14] + C1 + (LRegAa xor (LRegBb or not LRegCc)));
  LRegEe := TBitOperations.RotateLeft32(LRegEe, 9) + LRegDd;
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 10);
  LRegDd := LRegDd + (LData[7] + C1 + (LRegEe xor (LRegAa or not LRegBb)));
  LRegDd := TBitOperations.RotateLeft32(LRegDd, 9) + LRegCc;
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 10);
  LRegCc := LRegCc + (LData[0] + C1 + (LRegDd xor (LRegEe or not LRegAa)));
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 11) + LRegBb;
  LRegEe := TBitOperations.RotateLeft32(LRegEe, 10);
  LRegBb := LRegBb + (LData[9] + C1 + (LRegCc xor (LRegDd or not LRegEe)));
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 13) + LRegAa;
  LRegDd := TBitOperations.RotateLeft32(LRegDd, 10);
  LRegAa := LRegAa + (LData[2] + C1 + (LRegBb xor (LRegCc or not LRegDd)));
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 15) + LRegEe;
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 10);
  LRegEe := LRegEe + (LData[11] + C1 + (LRegAa xor (LRegBb or not LRegCc)));
  LRegEe := TBitOperations.RotateLeft32(LRegEe, 15) + LRegDd;
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 10);
  LRegDd := LRegDd + (LData[4] + C1 + (LRegEe xor (LRegAa or not LRegBb)));
  LRegDd := TBitOperations.RotateLeft32(LRegDd, 5) + LRegCc;
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 10);
  LRegCc := LRegCc + (LData[13] + C1 + (LRegDd xor (LRegEe or not LRegAa)));
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 7) + LRegBb;
  LRegEe := TBitOperations.RotateLeft32(LRegEe, 10);
  LRegBb := LRegBb + (LData[6] + C1 + (LRegCc xor (LRegDd or not LRegEe)));
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 7) + LRegAa;
  LRegDd := TBitOperations.RotateLeft32(LRegDd, 10);
  LRegAa := LRegAa + (LData[15] + C1 + (LRegBb xor (LRegCc or not LRegDd)));
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 8) + LRegEe;
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 10);
  LRegEe := LRegEe + (LData[8] + C1 + (LRegAa xor (LRegBb or not LRegCc)));
  LRegEe := TBitOperations.RotateLeft32(LRegEe, 11) + LRegDd;
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 10);
  LRegDd := LRegDd + (LData[1] + C1 + (LRegEe xor (LRegAa or not LRegBb)));
  LRegDd := TBitOperations.RotateLeft32(LRegDd, 14) + LRegCc;
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 10);
  LRegCc := LRegCc + (LData[10] + C1 + (LRegDd xor (LRegEe or not LRegAa)));
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 14) + LRegBb;
  LRegEe := TBitOperations.RotateLeft32(LRegEe, 10);
  LRegBb := LRegBb + (LData[3] + C1 + (LRegCc xor (LRegDd or not LRegEe)));
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 12) + LRegAa;
  LRegDd := TBitOperations.RotateLeft32(LRegDd, 10);
  LRegAa := LRegAa + (LData[12] + C1 + (LRegBb xor (LRegCc or not LRegDd)));
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 6) + LRegEe;
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 10);
  ...
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 13) + LRegE;
  LRegC := TBitOperations.RotateLeft32(LRegC, 10);
  LRegE := LRegE + (LData[8] + C2 + ((LRegAa and LRegB) or (not LRegAa and LRegC)));
  LRegE := TBitOperations.RotateLeft32(LRegE, 12) + LRegD;
  LRegB := TBitOperations.RotateLeft32(LRegB, 10);
  ...
  LRegD := TBitOperations.RotateLeft32(LRegD, 11) + LRegC;
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 10);
  LRegC := LRegC + (LData[10] + C4 + ((LRegD or not LRegE) xor LRegAa));
  LRegC := TBitOperations.RotateLeft32(LRegC, 13) + LRegBb;
  LRegE := TBitOperations.RotateLeft32(LRegE, 10);
  LRegBb := LRegBb + (LData[14] + C4 + ((LRegC or not LRegD) xor LRegE));
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 6) + LRegAa;
  LRegD := TBitOperations.RotateLeft32(LRegD, 10);
  LRegAa := LRegAa + (LData[4] + C4 + ((LRegBb or not LRegC) xor LRegD));
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 7) + LRegE;
  LRegC := TBitOperations.RotateLeft32(LRegC, 10);
  ...
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 15) + LRegAa;
  LRegD := TBitOperations.RotateLeft32(LRegD, 10);
  LRegAa := LRegAa + (LData[2] + C4 + ((LRegBb or not LRegC) xor LRegD));
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 14) + LRegE;
  LRegC := TBitOperations.RotateLeft32(LRegC, 10);
  LRegE := LRegE + (LData[7] + C4 + ((LRegAa or not LRegBb) xor LRegC));
  LRegE := TBitOperations.RotateLeft32(LRegE, 8) + LRegD;
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 10);
  LRegD := LRegD + (LData[0] + C4 + ((LRegE or not LRegAa) xor LRegBb));
  LRegD := TBitOperations.RotateLeft32(LRegD, 13) + LRegC;
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 10);
  LRegC := LRegC + (LData[6] + C4 + ((LRegD or not LRegE) xor LRegAa));
  LRegC := TBitOperations.RotateLeft32(LRegC, 6) + LRegBb;
  LRegE := TBitOperations.RotateLeft32(LRegE, 10);
  LRegBb := LRegBb + (LData[13] + C4 + ((LRegC or not LRegD) xor LRegE));
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 5) + LRegAa;
  LRegD := TBitOperations.RotateLeft32(LRegD, 10);
  ...
  LRegD := TBitOperations.RotateLeft32(LRegD, 5) + LRegC;
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 10);
  ...
  LRegEe := TBitOperations.RotateLeft32(LRegEe, 7) + LRegDd;
  LRegB := TBitOperations.RotateLeft32(LRegB, 10);
  ...
  LRegD := TBitOperations.RotateLeft32(LRegD, 14) + LRegCc;
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 10);
  ...
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 9) + LRegAa;
  LRegD := TBitOperations.RotateLeft32(LRegD, 10);
  LRegAa := LRegAa + (LData[4] + C6 + ((LRegBb and LRegD) or (LRegCc and not LRegD)));
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 8) + LRegE;
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 10);
  ...
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 5) + LRegBb;
  LRegE := TBitOperations.RotateLeft32(LRegE, 10);
  ...
  LRegE := TBitOperations.RotateLeft32(LRegE, 6) + LRegD;
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 10);
  LRegD := LRegD + (LData[6] + C6 + ((LRegE and LRegBb) or (LRegAa and not LRegBb)));
  LRegD := TBitOperations.RotateLeft32(LRegD, 5) + LRegCc;
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 10);
  LRegCc := LRegCc + (LData[2] + C6 + ((LRegD and LRegAa) or (LRegE and not LRegAa)));
  LRegCc := TBitOperations.RotateLeft32(LRegCc, 12) + LRegBb;
  LRegE := TBitOperations.RotateLeft32(LRegE, 10);
  ...
  LRegA := TBitOperations.RotateLeft32(LRegA, 8) + LRegEe;
  LRegC := TBitOperations.RotateLeft32(LRegC, 10);
  ...
  LRegEe := TBitOperations.RotateLeft32(LRegEe, 5) + LRegDd;
  LRegB := TBitOperations.RotateLeft32(LRegB, 10);
  LRegDd := LRegDd + (LData[10] + C7 + ((LRegEe and LRegA) or (not LRegEe and LRegB)));
  LRegDd := TBitOperations.RotateLeft32(LRegDd, 15) + LRegC;
  LRegA := TBitOperations.RotateLeft32(LRegA, 10);
  ...
  LRegE := TBitOperations.RotateLeft32(LRegE, 11) + LRegDd;
  LRegBb := TBitOperations.RotateLeft32(LRegBb, 10);
  LRegDd := LRegDd + (LData[6] + C8 + (LRegE xor (LRegAa or not LRegBb)));
  LRegDd := TBitOperations.RotateLeft32(LRegDd, 8) + LRegCc;
  LRegAa := TBitOperations.RotateLeft32(LRegAa, 10);
  ...
  LRegB := TBitOperations.RotateLeft32(LRegB, 8) + LRegA;
  LRegD := TBitOperations.RotateLeft32(LRegD, 10);
  LRegA := LRegA + (LData[15] + (LRegB xor LRegC xor LRegD));
  LRegA := TBitOperations.RotateLeft32(LRegA, 5) + LRegEe;
  LRegC := TBitOperations.RotateLeft32(LRegC, 10);
  LRegEe := LRegEe + (LData[10] + (LRegA xor LRegB xor LRegC));
  LRegEe := TBitOperations.RotateLeft32(LRegEe, 12) + LRegD;
  LRegB := TBitOperations.RotateLeft32(LRegB, 10);
  ...
  LRegEe := TBitOperations.RotateLeft32(LRegEe, 6) + LRegD;
  LRegB := TBitOperations.RotateLeft32(LRegB, 10);
  LRegD := LRegD + (LData[6] + (LRegEe xor LRegA xor LRegB));
  LRegD := TBitOperations.RotateLeft32(LRegD, 8) + LRegC;
  LRegA := TBitOperations.RotateLeft32(LRegA, 10);
  LRegC := LRegC + (LData[2] + (LRegD xor LRegEe xor LRegA));
  LRegC := TBitOperations.RotateLeft32(LRegC, 13) + LRegB;
  LRegEe := TBitOperations.RotateLeft32(LRegEe, 10);
  ...
  LRegEe := TBitOperations.RotateLeft32(LRegEe, 15) + LRegD;
  LRegB := TBitOperations.RotateLeft32(LRegB, 10);
  ...
  LRegB := TBitOperations.RotateLeft32(LRegB, 11) + LRegA;
  LRegD := TBitOperations.RotateLeft32(LRegD, 10);
