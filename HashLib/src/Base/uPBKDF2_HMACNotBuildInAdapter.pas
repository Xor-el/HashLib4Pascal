unit uPBKDF2_HMACNotBuildInAdapter;
...
type
  ...
  TPBKDF2_HMACNotBuildInAdapter = class sealed(TInterfacedObject, IPBKDF2_HMAC,
...
uses
  uHashFactory; // placed here because of circular dependency.
